...
class TestWaitingQueueScorer:
    ...
    def test_score_basic(self):
        ...
        endpoints = {
            "ep1": Endpoint(name="ep1", attributes={"routing_stats": {"num_waiting_reqs": 10}}),
            "ep2": Endpoint(name="ep2", attributes={"routing_stats": {"num_waiting_reqs": 50}}),
            "ep3": Endpoint(name="ep3", attributes={"routing_stats": {"num_waiting_reqs": 100}}),
        }
    ...
    def test_score_all_equal(self):
        ...
        endpoints = {
            "ep1": Endpoint(name="ep1", attributes={"routing_stats": {"num_waiting_reqs": 20}}),
            "ep2": Endpoint(name="ep2", attributes={"routing_stats": {"num_waiting_reqs": 20}}),
        }
    ...
    def test_score_empty_stats(self):
        ...
        endpoints = {
            ...
            "ep2": Endpoint(name="ep2", attributes={"routing_stats": {"num_waiting_reqs": 10}}),
        }
